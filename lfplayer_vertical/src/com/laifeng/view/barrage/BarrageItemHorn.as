package com.laifeng.view.barrage
{
	...
	public class BarrageItemHorn extends Sprite implements IBarrage
	{
		...
		private const ROW_HEIGHT:int = 30;
		...
		public function setInfo(info:Object):void
		{
			...
			var name:String = "<font size='12' color='#ff5d93' face='微软雅黑,Microsoft YaHei,Arial'>";
			name += info["info"]["n"]+"  ";
			name += "</font>";
			
			var msg:String = "<font size='12' color='#f7dd66' face='微软雅黑,Microsoft YaHei,Arial'>";
			msg+= info["info"]["m"];
			msg+="</font>";
			
			
			_tf.htmlText = name+msg;
			_tf.width =Util.getTfWidth(_tf)+25;
			...
			this.graphics.drawRoundRect(0,-5,_tf.width,_tf.height,30,30);
