package com.laifeng.view.plugs.guide.showroom
{
	...
	import com.laifeng.view.plugs.guide.BtnGuide;
	...
	public class GuideItemShowroom extends Sprite
	{
		...
		public function GuideItemShowroom()
		{
			...
			_img.bitmapData =new BitmapData(90,50,false,0xFFFFFF)
		...
		public function setData(data:Object):void
		{
			...
			if(data["livehouse"]){
				...
				html = "<p align='left'> <font size='12' color='#7f6b8c' face='微软雅黑,Microsoft YaHei,Arial'>";
		...
		private function delayAddImg():void{
			this.addChild(_img);
		}
